 ...
 */
export async function genKeyPairAndSeed(length = 32) {
 ...
 */
export async function genKeyPairFromSeed(seedString) {
    await sodium.ready;
 ...
 */
export async function deriveEd25519(masterKey, dataSeed, deriveLength) {
    await sodium.ready;
    let hasher;
    if (deriveLength) {
